...
let kategori = "760107014788612166"
...
.setTitle(`Ultra Kod Paylaşıldı!`)
.setDescription(`20 Davet ile Erişebiliceğiniz Bir Kod Paylaşıldı!\n ‍`)
...
exports.conf = {
    enabled: true,
    guildOnly: false,
    aliases: ['ultra-paylaş', 'ultrapaylaş'],
    permLevel: 0
  };
